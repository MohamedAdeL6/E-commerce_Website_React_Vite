    ...
    <div className="row m-0">
      {products.map((item) => {
        return (
          <Col
            key={item.id}
            className="border d-flex justify-content-center py-3 px-3"
          >
            <CartBox className="d-flex flex-wrap gap-3">
              ...
              >
                <CartBoxImage className="image-box w-100 text-center shadow rounded-4" 
                 style={{
                      height: "200px",
                      marginBottom: "10px",
                      padding: "10px",
                ...
                <div className="d-flex flex-wrap justify-content-center text-center gap-1 pb-2">
                  <h6 className="fw-bold " style={{width: "max-width"}}> {item.type.slice(0, 20)} </h6>

                  <CartBoxParag style={{ fontSize: "14px", margin: "0", width: "100%", height: "46px", overflow: "hidden" }}>
                    {" "}
